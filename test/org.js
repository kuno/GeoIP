...
setTimeout(function() {
  ...
  console.log('The result of method');
...
setTimeout(function() {
  ...
  console.log('Org.org_by_domain(data, \'www.google.com\')');
  Org.org_by_domain(org_data, 'www.yahoo.com', function(err, org) {
    if (err) {throw err;}
...
setTimeout(function() {
  console.log('The result of asynchronized method');
  console.log('Org.asn_by_domain(data, \'www.google.com\')');
