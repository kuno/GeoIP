...
*  Inter Functions
*****************************************************************************/
function __id_by_addr__(data, addr) {
  if (addr !== false) {
...
function __id_by_domain__(data, domain, callback) {
  var country_id;
  var ipnum;
...
exports.code_by_domain = function(data, domain, callback) {
  ...
  if (data.db_type !== CONST.COUNTRY_EDITION && 
    ...
    __id_by_domain__(data, domain, function(error, country_id) {
...
exports.code_by_addr = function(data, addr) {
  ...
  if (data.db_type !== CONST.COUNTRY_EDITION && 
    ...
    country_id = __id_by_addr__(data, addr);
    if (!country_id) {
      return null;
    } else {
